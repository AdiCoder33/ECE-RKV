...
const ContactAlumni = () => (
  <div className="min-h-[60vh] flex flex-col items-center justify-center">
    <img
      src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f477.png"
      alt="Under Construction"
      className="w-20 h-20 mb-4 animate-bounce"
    />
    <h2 className="text-2xl font-bold mb-2 text-[#b91c1c]">Page Under Progress</h2>
    <p className="text-lg text-[#2563eb]">This feature will be available soon...</p>
  </div>
);
