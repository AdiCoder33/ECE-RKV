...
const StudentProfile = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-5xl space-y-6 px-2 sm:px-4 py-4 sm:py-6 md:px-8">
        {/* Back Button */}
        <div className="mb-2">
          <button
            onClick={() => navigate(-1)}
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="space-y-2 text-center sm:text-left">
            <h1 className="text-3xl font-bold text-[#8b0000]">{student.name}</h1>
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-gray-600">
