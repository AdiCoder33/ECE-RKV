...
const ProfessorDashboard = () => {
  ...
  const THEME = {
    bgBeige: '#fbf4ea',
    accent: '#8b0000',
    cardFrom: '#fff8f5', // light beige
    cardTo: '#f3d1ce', // pale maroon
    headerFrom: '#fff1f0', // very light rose
    headerTo: '#f8d7d7' // soft maroon
  };
  ...
  return (
    ...
    >
      {/* Header */}
      <Card
        className={`bg-gradient-to-r from-[${THEME.headerFrom}] to-[${THEME.headerTo}] border-none shadow-sm`}
      >
