...
const MessageItem: React.FC<MessageItemProps> = ({
  ...
  const bubbleClass =
    "inline-flex items-end whitespace-pre-wrap px-2 pt-2 pb-5 rounded-2xl shadow-sm max-w-[80%] min-w-[3rem] break-words break-all relative after:absolute after:-bottom-1 after:w-0 after:h-0";
  let bubbleColor = '';
  let nameTextColor = '';
  if (isOwn) {
